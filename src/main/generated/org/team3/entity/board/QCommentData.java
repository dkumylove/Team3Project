...
public class QCommentData extends EntityPathBase<CommentData> {
    ...
    private static final long serialVersionUID = 552292344L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QCommentData commentData = new QCommentData("commentData");

    public final org.team3.entity.abstractCommon.QBase _super = new org.team3.entity.abstractCommon.QBase(this);
    ...
    public final org.team3.entity.member.QMember member;
    ...
    public QCommentData(Class<? extends CommentData> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new org.team3.entity.member.QMember(forProperty("member")) : null;
    }
